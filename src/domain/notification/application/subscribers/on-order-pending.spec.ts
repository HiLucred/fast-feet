...
describe('On Order Pending', () => {
  ...
  beforeEach(() => {
    ...
    new OnOrderPending(sendNotificationUseCase) // Antes de começar o código, um Listener fica "ouvindo" o evento
  ...
  it('should be able to subscribe on order delivery event', async () => {
    ...
    order.markAsPending() // Aqui eu marco que o evento foi acionado, porém não aciono ainda
